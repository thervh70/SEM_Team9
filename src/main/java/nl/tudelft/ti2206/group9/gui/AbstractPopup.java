...
public abstract class AbstractPopup extends Popup {
	...
	/** Size of the HBox. */
	protected static final double HBOX_SIZE = 10;
	/** Size of the VBox. */
	protected static final double VBOX_SIZE = 50;
	...
	public AbstractPopup(final Button leftButton, final Button rightButton) {
        ...
        final HBox hbox = new HBox(HBOX_SIZE, left, right);
        ...
        final VBox vbox = new VBox(VBOX_SIZE, content2);
